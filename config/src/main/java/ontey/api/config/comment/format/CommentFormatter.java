...
public interface CommentFormatter {
	...
	@NonNull
	static String format(int indent, @Nullable String prefixFirst, @Nullable String prefixMultiline, @Nullable String comment, @NonNull CommentType type, @Nullable String suffixMultiline, @Nullable String suffixLast) {
	...
	static String format(@Nullable String prefixFirst, @Nullable String prefixMultiline, @Nullable String comment, @Nullable String suffixMultiline, @Nullable String suffixLast) {
		return format(0, prefixFirst, prefixMultiline, comment, CommentType.BLOCK, suffixMultiline, suffixLast);
	}
	
	static String format(int indent, @Nullable String comment, @NonNull CommentType type, @NonNull CommentFormatterConfig config) {
		return format(
		  indent,
		  config.prefixFirst(),
		  config.prefixMultiline(),
		  comment,
		  type,
		  config.suffixMultiline(),
		  config.suffixLast()
		);
	}
