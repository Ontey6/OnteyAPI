...
public class YamlImplementationTest {
	 ...
	 * <br>This test shows how to use that with Simple-YAML, using {@link SnakeYamlImplementation}.
	 * <br>The output though is not exactly the same as {@link SimpleYamlImplementation} comment parser/dumper,
