...
public final class YamlExample {
	...
	public static void main(String[] args) {
		...
		ConfigSection section = yamlFile.createSection("timestamp");
		...
		section = yamlFile.getSection("test");
		...
		System.out.println("Is " + section.getPath() + " a ConfigurationSection?: "
		  + yamlFile.isSection(section.getPath()) + "\n");
		...
		System.out.println(section.getPath() + " keys: " + keys);
