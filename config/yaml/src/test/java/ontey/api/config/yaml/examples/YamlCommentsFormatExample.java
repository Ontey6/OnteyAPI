...
import ontey.api.config.yaml.comment.format.BlankLineYamlCommentFormatter;
...
public class YamlCommentsFormatExample {
	...
	public static void main(String[] args) throws IOException {
		...
		final String prefixMultiline = YamlCommentFormatterConfig.DEFAULT_COMMENT_PREFIX; // Prefix for other comment lines (default)
