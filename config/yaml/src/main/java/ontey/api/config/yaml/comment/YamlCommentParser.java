...
public class YamlCommentParser extends YamlCommentReader {
	...
	public YamlCommentParser(@NonNull YamlConfigOptions options, @NonNull Reader reader) {
		super(options);
		this.reader = reader instanceof BufferedReader buf ? buf : new BufferedReader(reader);
	}
	
	public static String removeHeader(String blockComment, YamlConfigOptions options) {
