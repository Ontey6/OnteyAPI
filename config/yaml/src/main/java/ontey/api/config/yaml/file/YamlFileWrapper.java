...
import ontey.api.config.ConfigWrapper;
...
public class YamlFileWrapper extends ConfigWrapper<YamlFile> {
	 ...
	 * <br>
	 * Comment format will follow the rules of {@link YamlFile#options()} {@link YamlConfigOptions#commentFormatter()}.
	 *
