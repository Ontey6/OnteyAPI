...
public class ItemBuilder {
   ...
   @NonNull
   public ItemBuilder lore(@Nullable Component @NonNull ... name) {
   ...
   @NonNull
   public ItemBuilder lore(@Nullable String @NonNull ... name) {
      return lore(Arrays.stream(name).filter(Objects::nonNull).map(MinecraftColor::colorize).toArray(Component[]::new));
   }
