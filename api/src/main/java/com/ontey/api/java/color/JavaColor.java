package com.ontey.api.java.color;
...
public class JavaColor {
   ...
   public static final String RESET = preset(0);
   
   /**
    * Makes text bold.
    */
   
   public static final String BOLD = preset(1);
   ...
   @Deprecated
   public static final String DIM = preset(2);
   
   /**
    * Italicizes text; makes the upper half shift towards right.
    */
   
   public static final String ITALIC = preset(3);
   
   /**
    * Underlines text.
    */
   
   public static final String UNDERLINE = preset(4);
   ...
   @Deprecated
   public static final String BLINK = preset(5);
   
   /**
    * Inverts fore- and background colors
    */
   
   public static final String REVERSE = preset(7);
   
   /**
    * Inverts fore- and background colors
    */
   
   public static final String INVERT = REVERSE;
   ...
   @Deprecated
   public static final String HIDDEN = preset(8);
   ...
   public static final String STRIKETHROUGH = preset(9);
   ...
   public static String colorize(String str, boolean clampRGB) {
   ...
   public static String replaceRGB(String str) {
   ...
   public static String replaceRGB(String str, boolean clampRGB) {
