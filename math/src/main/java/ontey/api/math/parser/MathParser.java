...
import ontey.api.math.MathUtils;
...
import static ontey.api.math.parser.MathParser.Config.DEFAULT;
import static ontey.api.math.parser.Token.Type.*;
...
public class MathParser {
	...
	private final Map<@NonNull String, @NonNull Variable> variables = new HashMap<>();
	
	private final Map<@NonNull String, @NonNull Function> functions = new HashMap<>();
	
	private final Map<@NonNull String, @NonNull Operator> operators = new HashMap<>();
	...
	public static class PresetCreator {
		...
		public static Preset combined(@NonNull Preset @NonNull ... presets) {
			return Preset.combine(presets);
		}
		
		public Preset of(@NonNull Consumer<@NonNull MathParser> action) {
	...
	public static class Config {
		...
		List<Character> ignoredCharacters;
	}
